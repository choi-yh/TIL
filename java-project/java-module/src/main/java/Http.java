...
//    public static <T> T httpGET(String path, Class<T> responseType) {
//        try {
...
//
//            // Convert JSON response to the desired type using custom deserializer
//            return Json.fromJson(response.toString(), responseType);
//        } catch (IOException e) {
//            e.printStackTrace();
//        } catch (Exception e) {
//            throw new RuntimeException(e);
...
//    }
//
//    public static <T> T httpPOST(String path, Object body, Class<T> responseType) {
//        try {
//            HttpURLConnection connection = postHttpURLConnection(path);
//
//            // Connect to the server
//            connection.connect();
//
//            // Make JsonInputString
//            String jsonInputString = Json.toJson(body);
//
//            // Write the JSON body to the output stream
//            try (OutputStream os = connection.getOutputStream()) {
//                byte[] input = jsonInputString.getBytes("utf-8");
...
//    }
//
//    private static HttpURLConnection postHttpURLConnection(String path) throws IOException {
//        URL url = new URL(BASE_URL + path);
//
//        // Open a connection to the URL using the HttpURLConnection class
//        HttpURLConnection connection = (HttpURLConnection) url.openConnection();
